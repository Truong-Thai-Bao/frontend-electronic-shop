...
const HeaderComponent = ({ isHiddenSearch = false, isHiddenCart = false }) => {
  ...
  return (
    <div style={{  heiht: '100%', width: '100%', display: 'flex',background: '#d0011b', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={5}>
          <WrapperTextHeader to='/'>ELECTRIC SHOP</WrapperTextHeader>
        </Col>
        {!isHiddenSearch && (
          <Col span={11}>
            <ButttonInputSearch
              ...
              onChange={onSearch}
              backgroundColorButton="rgba(18, 85, 243, 1)"
            />
          </Col>
        )}
